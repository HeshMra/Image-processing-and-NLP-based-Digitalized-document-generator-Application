    ...
    <div className="c-body">
      <div className="form-body-common ">
        <div className="body-content mt-auto flex flex-wrap ">
          ...
          <div className="content-panel w-full md:w-2/3 px-4 p-5">
            <div className="content-panel-container w-full bg-slate-100 p-[10px] text-left font-link text-black">
              <h3 className="text-black text-bold"> Conclusion</h3>
                <p className="mx-5 text-[10pt]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellat ratione laboriosam nulla blanditiis consectetur nobis delectus praesentium? Harum, ea assumenda.</p>
        ...
        <div className=" w-full control-options flex fles-wrap justify-around mx-1">
          <button className="btn bg-white text-blue-600 text-bold"> Add</button>
          <button className="btn  bg-white text-red-500 text-bold"> Add your Own Idea</button>
