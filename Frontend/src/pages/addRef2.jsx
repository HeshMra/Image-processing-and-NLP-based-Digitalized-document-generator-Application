  ...
  return (
    <div className="c-body">
      ...
      {/* <div className="file-path text-left text-white">
            <span> Home / Handwriten Images insertion page / Handwritten Images conversion page / Deadline adding page / Handwritten images display page / Voice to text / Grammar Checker / References add page</span>
        </div> */}
        <div className="body-content mt-auto flex flex-wrap">
          ...
          <div className="content-panel w-full md:w-2/3 px-4 p-5">
            ...
            <ol className="mx-6 font-link text-[10pt]">
        ...
        <div className=" w-full control-options flex fles-wrap justify-around mx-1">
          <button className="btn bg-white text-blue-600 text-bold"> Done</button>
          <button className="btn bg-white text-blue-600 text-bold"> Update</button>
          <button className="btn bg-white text-blue-600 text-bold"> Proceed to create references list</button>
...
export default ReferencesAddPage;
