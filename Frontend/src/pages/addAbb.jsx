...
function Addabbreviations() {
  ...
  const handleChange = (e) => {
    ...
    const questionList = [
      {description: 'JSML', key: 0},
      {description: 'PMSL', key: 1},
      {description: 'AUTH', key: 2}
    ];
    ...
    <div className="c-body">
      <div className="form-body-common">
        ...
        <div className=" w-full control-options flex fles-wrap justify-around mx-1">
          ...
          <button className="btn  bg-white text-purple-600 text-bold" > Create an abbreviation List</button>
        </div>
...
export default Addabbreviations;
