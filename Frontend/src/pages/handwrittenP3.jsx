...
function HandwrittenConversion3() {
    ...
    <div className="c-body">
      <div className="form-body-common">
        {/* <div className="file-path text-left text-white">
            <span> Home / Handwriten Images insertion page / Handwritten Images conversion page / Deadline adding page / Handwritten images display page </span>
        </div> */}
        ...
        <div className="page-info block w-full my-1">
            <span className="text-white font-link ">Total added images : {numImages}</span>
        </div>
        <div className=" w-full control-options flex fles-wrap justify-end mx-1">
        
        
          <button className="btn  bg-white text-purple-600 text-bold" > Add voice text</button>
        </div>
...
export default HandwrittenConversion3;
