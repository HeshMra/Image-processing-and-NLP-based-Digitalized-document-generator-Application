      ...
      <div className="form-body-common">
        <div className="body-content mt-auto flex flex-wrap">
          ...
          <div className="content-panel w-full md:w-2/3 px-4 p-5">
            <div className="content-panel-container w-full  text-left font-link text-black bg-white p-[10px]">
                ...
                <li>
                  <label htmlFor="link1">
                    <input
                      ...
                      name="fruit"
                      value="link1"
                      checked={selected === "link1"}
                      onChange={handleChange}
                    />
                    <span className="px-2  text-black">https://edu.uk/sample/resources/09876554</span>
                  </label>
                </li>
                <li>
                <label htmlFor="link2">
                    <input
                      ...
                      name="fruit"
                      value="link2"
                      checked={selected === "link2"}
                      onChange={handleChange}
                    />
                    <span className="px-2  text-black">https://edu.uk/sample/bio/0F76554</span>
                  </label>
                </li>
                <li>
                <label htmlFor="link3">
                    <input
                      ...
                      name="fruit"
                      value="link3"
                      checked={selected === "link3"}
                      onChange={handleChange}
                    />
                    <span className="px-2  text-black">https://edu.uk/sample/E/profile/09876454</span>
                  </label>
                </li>
              </ul>
            </div>
